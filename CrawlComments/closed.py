# https://github.com/tensorflow/tensorflow/issues?page=3&q=is%3Aissue+is%3Aclosed
...
def gettitle(page=1):
	try:
		url="https://github.com/tensorflow/tensorflow/issues?page="+str(page)+"&q=is%3Aissue+is%3Aclosed"
